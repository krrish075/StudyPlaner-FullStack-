...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || 'Failed to successfully login. Please try again.');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
            ...
            <div className="absolute top-[20%] left-[20%] w-[30%] h-[30%] rounded-full bg-primary-400/10 dark:bg-primary-600/5 blur-3xl -z-10" />
            ...
            >
                <div className="p-8 sm:p-10">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 mt-2">Enter your credentials to access your planner</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-1">
                            <div className="flex items-center justify-between ml-1">
                                ...
                                <a href="#" className="text-xs font-medium text-primary-600 dark:text-primary-400 hover:text-primary-500">Forgot password?</a>
                            </div>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-3.5 px-4 bg-primary-600 hover:bg-primary-500 active:scale-[0.98] transition-all text-white font-semibold rounded-xl shadow-lg shadow-primary-500/20 flex justify-center items-center gap-2 group disabled:opacity-70 disabled:pointer-events-none"
                        >
